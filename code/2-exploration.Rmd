...
library(dplyr)
library(readr)
source("~/pregnancy-weight-gain-final-project/code/scripts/R_rainclouds.R")
```

```{r}
# load cleaned data
pdiet_data = read.csv("~/pregnancy-weight-gain-final-project/data/clean/pregnancy_data.csv") %>% na.omit()
```
