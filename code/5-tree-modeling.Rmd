...
```
```{r}
# calculate train rmse and test rmses
test_rf_probabilities = predict(rfit_final, newdata = pregnancy_test)
test_RMSE_rf = sqrt(mean((test_rf_probabilities - pregnancy_test$pregnancy_weight_gain)^2))
